...
import Ejercicio02_03.Moldes.Electrodomestico;
import Ejercicio02_03.Moldes.Lavadora;
import Ejercicio02_03.Moldes.Televisor;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Lavadora x1 = new Lavadora();
        x1.crearLavadora();
        x1.precioFinal();
        System.out.println("---------------------");
        Lavadora x2 = new Lavadora();
        x2.crearLavadora();
        x2.precioFinal();
        System.out.println("---------------------");
        Televisor y1 = new Televisor();
        y1.crearTelevisor();
        y1.precioFinal();
        System.out.println("---------------------");
        Televisor y2 = new Televisor();
        y2.crearTelevisor();
        y2.precioFinal();
        System.out.println("---------------------");
        System.out.println("*******************************************************");
        ArrayList<Electrodomestico> electrodomesticos = new ArrayList();
        electrodomesticos.add(x1);
        electrodomesticos.add(x2);
        electrodomesticos.add(y1);
        electrodomesticos.add(y2);
